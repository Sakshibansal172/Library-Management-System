    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> BookView(string searchstring)
        {
            ...
            if (!string.IsNullOrEmpty(searchstring)) {
                lMS_ProjectContext = _context.Books.Where(b => b.Author.AuthorName.Contains(searchstring) || b.Category.Contains(searchstring) || b.BookTitle.Contains(searchstring)).Include(b => b.Author).Include(b => b.Publisher); }
